...
\hlkwd{stargazer}\hlstd{(}
 ...
 \hlstd{,}\hlkwc{notes.append} \hlstd{=} \hlnum{TRUE}\hlstd{,}\hlkwc{label} \hlstd{=} \hlstr{"D1"}\hlstd{)}
\end{alltt}
\end{kframe}
% Table created by stargazer v.5.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: 週六, 十月 15, 2016 - 下午 11:56:12
...
\end{kframe}
% Table created by stargazer v.5.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: 週六, 十月 15, 2016 - 下午 11:56:24
...
\begin{alltt}
  ...
  \hlstd{lm.ETR2} \hlkwb{<-} \hlkwd{lm}\hlstd{(ETR} \hlopt{~} \hlstd{STR.PR}\hlopt{+}\hlstd{HHI_Dum}\hlopt{+}\hlstd{ROA}\hlopt{+}\hlstd{SIZE}\hlopt{+}\hlstd{LEV}\hlopt{+}\hlstd{INTANG}\hlopt{+}\hlstd{QUICK}\hlopt{+}\hlstd{EQINC}\hlopt{+}\hlstd{OUTINSTI}\hlopt{+}\hlstd{RELAT}\hlopt{+}\hlstd{FAM_Dum}\hlopt{+}\hlstd{GDP,TEJ8.2)}
  \hlstd{lm.CETR2} \hlkwb{<-} \hlkwd{lm}\hlstd{(CETR} \hlopt{~} \hlstd{STR.PR}\hlopt{+}\hlstd{HHI_Dum}\hlopt{+}\hlstd{ROA}\hlopt{+}\hlstd{SIZE}\hlopt{+}\hlstd{LEV}\hlopt{+}\hlstd{INTANG}\hlopt{+}\hlstd{QUICK}\hlopt{+}\hlstd{EQINC}\hlopt{+}\hlstd{OUTINSTI}\hlopt{+}\hlstd{RELAT}\hlopt{+}\hlstd{FAM_Dum}\hlopt{+}\hlstd{GDP,TEJ8.2)}
  \hlstd{lm.ETR.SH2} \hlkwb{<-} \hlkwd{lm}\hlstd{(ETR} \hlopt{~} \hlstd{STR.PR}\hlopt{+}\hlstd{HHI_Dum}\hlopt{+}\hlstd{STR.PR_HHI}\hlopt{+}\hlstd{ROA}\hlopt{+}\hlstd{SIZE}\hlopt{+}\hlstd{LEV}\hlopt{+}\hlstd{INTANG}\hlopt{+}\hlstd{QUICK}\hlopt{+}\hlstd{EQINC}\hlopt{+}\hlstd{OUTINSTI}\hlopt{+}\hlstd{RELAT}\hlopt{+}\hlstd{FAM_Dum}\hlopt{+}\hlstd{GDP,TEJ8.2)}
  \hlstd{lm.CETR.SH2} \hlkwb{<-} \hlkwd{lm}\hlstd{(CETR} \hlopt{~} \hlstd{STR.PR}\hlopt{+}\hlstd{HHI_Dum}\hlopt{+}\hlstd{STR.PR_HHI}\hlopt{+}\hlstd{ROA}\hlopt{+}\hlstd{SIZE}\hlopt{+}\hlstd{LEV}\hlopt{+}\hlstd{INTANG}\hlopt{+}\hlstd{QUICK}\hlopt{+}\hlstd{EQINC}\hlopt{+}\hlstd{OUTINSTI}\hlopt{+}\hlstd{RELAT}\hlopt{+}\hlstd{FAM_Dum}\hlopt{+}\hlstd{GDP,TEJ8.2)}
\end{alltt}
\end{kframe}
...
\end{kframe}
% Table created by stargazer v.5.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: 週六, 十月 15, 2016 - 下午 11:56:26
\begin{table}[!htbp] \centering 
  \caption{} 
  \label{F1} 
\begin{tabular}{@{\extracolsep{5pt}}lcc} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{TEJ8.3} \hlkwb{<-} \hlkwd{merge}\hlstd{(}
    \hlkwd{merge}\hlstd{(}
      \hlkwc{x}\hlstd{=TEJ8.1} \hlopt{%>%} \hlkwd{group_by}\hlstd{(TSE_code,year)} \hlopt{%>%} \hlkwd{summarise}\hlstd{(}\hlkwc{NetSales.Deno} \hlstd{=} \hlkwd{sum}\hlstd{(}\hlkwd{as.numeric}\hlstd{(NetSales),}\hlkwc{na.rm}\hlstd{=}\hlnum{TRUE}\hlstd{)),}
      \hlkwc{y}\hlstd{=TEJ8.1} \hlopt{%>%} \hlkwd{group_by}\hlstd{(TSE_code,year)} \hlopt{%>%} \hlkwd{top_n}\hlstd{(}\hlkwc{n}\hlstd{=}\hlnum{4}\hlstd{,}\hlkwc{wt} \hlstd{= NetSales)} \hlopt{%>%} \hlkwd{summarise}\hlstd{(}\hlkwc{NetSales.nume} \hlstd{=} \hlkwd{sum}\hlstd{(}\hlkwd{as.numeric}\hlstd{(NetSales),}\hlkwc{na.rm}\hlstd{=}\hlnum{TRUE}\hlstd{)),}
      \hlkwc{by}\hlstd{=}\hlkwd{c}\hlstd{(}\hlstr{"TSE_code"}\hlstd{,}\hlstr{"year"}\hlstd{))} \hlopt{%>%}
    \hlkwd{mutate}\hlstd{(}\hlkwc{CR4} \hlstd{=} \hlkwd{as.numeric}\hlstd{(NetSales.nume} \hlopt{/} \hlstd{NetSales.Deno))}
    \hlstd{,}\hlkwc{y}\hlstd{=TEJ8.1}
    \hlstd{,}\hlkwc{by}\hlstd{=}\hlkwd{c}\hlstd{(}\hlstr{"TSE_code"}\hlstd{,}\hlstr{"year"}\hlstd{)}
    \hlstd{)} \hlopt{%>%} \hlkwd{mutate}\hlstd{(}\hlkwc{STR_CR4} \hlstd{= STR} \hlopt{*} \hlstd{CR4)}

  \hlstd{lm.ETR3} \hlkwb{<-} \hlkwd{lm}\hlstd{(ETR} \hlopt{~} \hlstd{STR}\hlopt{+}\hlstd{CR4}\hlopt{+}\hlstd{ROA}\hlopt{+}\hlstd{SIZE}\hlopt{+}\hlstd{LEV}\hlopt{+}\hlstd{INTANG}\hlopt{+}\hlstd{QUICK}\hlopt{+}\hlstd{EQINC}\hlopt{+}\hlstd{OUTINSTI}\hlopt{+}\hlstd{RELAT}\hlopt{+}\hlstd{FAM_Dum}\hlopt{+}\hlstd{GDP,TEJ8.3)}
  \hlstd{lm.CETR3} \hlkwb{<-} \hlkwd{lm}\hlstd{(CETR} \hlopt{~} \hlstd{STR}\hlopt{+}\hlstd{CR4}\hlopt{+}\hlstd{ROA}\hlopt{+}\hlstd{SIZE}\hlopt{+}\hlstd{LEV}\hlopt{+}\hlstd{INTANG}\hlopt{+}\hlstd{QUICK}\hlopt{+}\hlstd{EQINC}\hlopt{+}\hlstd{OUTINSTI}\hlopt{+}\hlstd{RELAT}\hlopt{+}\hlstd{FAM_Dum}\hlopt{+}\hlstd{GDP,TEJ8.3)}
  \hlstd{lm.ETR.SH3} \hlkwb{<-} \hlkwd{lm}\hlstd{(ETR} \hlopt{~} \hlstd{STR}\hlopt{+}\hlstd{CR4}\hlopt{+}\hlstd{STR_CR4}\hlopt{+}\hlstd{ROA}\hlopt{+}\hlstd{SIZE}\hlopt{+}\hlstd{LEV}\hlopt{+}\hlstd{INTANG}\hlopt{+}\hlstd{QUICK}\hlopt{+}\hlstd{EQINC}\hlopt{+}\hlstd{OUTINSTI}\hlopt{+}\hlstd{RELAT}\hlopt{+}\hlstd{FAM_Dum}\hlopt{+}\hlstd{GDP,TEJ8.3)}
  \hlstd{lm.CETR.SH3} \hlkwb{<-} \hlkwd{lm}\hlstd{(CETR} \hlopt{~} \hlstd{STR}\hlopt{+}\hlstd{CR4}\hlopt{+}\hlstd{STR_CR4}\hlopt{+}\hlstd{ROA}\hlopt{+}\hlstd{SIZE}\hlopt{+}\hlstd{LEV}\hlopt{+}\hlstd{INTANG}\hlopt{+}\hlstd{QUICK}\hlopt{+}\hlstd{EQINC}\hlopt{+}\hlstd{OUTINSTI}\hlopt{+}\hlstd{RELAT}\hlopt{+}\hlstd{FAM_Dum}\hlopt{+}\hlstd{GDP,TEJ8.3)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\end{kframe}
% Table created by stargazer v.5.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: 週六, 十月 15, 2016 - 下午 11:56:28
\begin{table}[!htbp] \centering 
  \caption{} 
  \label{F4} 
\begin{tabular}{@{\extracolsep{5pt}}lcc} 
...
\end{kframe}
% Table created by stargazer v.5.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: 週六, 十月 15, 2016 - 下午 11:56:29
\begin{table}[!htbp] \centering 
  \caption{} 
  \label{F5} 
\begin{tabular}{@{\extracolsep{5pt}}lcc} 
